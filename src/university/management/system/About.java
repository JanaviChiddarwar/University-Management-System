...
public class About extends JFrame
{
    ...
    About()
    {
        ...
        JLabel heading = new JLabel("<html>Chiddarwar University</html>");
        heading.setBounds(40, 30, 300, 120);
        heading.setFont(new Font("Tahoma", Font.BOLD, 30));
        add(heading);

        JLabel name = new JLabel("Gk & Sons");
        name.setBounds(60,260,550,40);
        name.setFont(new Font("Tahoma", Font.BOLD,30));
        add(name);

        JLabel contact = new JLabel("gkpusad@gmail.com");
